...
<div class="flex justify-center">
    <div class="flex flex-col bg-[#343434] m-16  py-6  px-8 rounded">
        ...
        <form action="../controller/updateUserAdmin.php" class="flex flex-col space-y-3" method="post">
            ...
            <input name="firstName" type="text" placeholder="Prénom" value="<?php echo $data['first_name'] ?>"
                   class=" py-3 px-4 border border-gray-400 rounded-md"/>
            <input name="lastName" type="text" placeholder="Nom" value="<?php echo $data['last_name'] ?>"
                   class=" py-3 px-4 border border-gray-400 rounded-md"/>
            <input name="username" type="text" placeholder="Nom d'utilisateur" value="<?php echo $data['username'] ?>"
                   class=" py-3 px-4 border border-gray-400 rounded-md"/>
            ...
            <input name="password" type="password" placeholder="Mot de passe" value="<?php echo $data['password'] ?>"
                   class=" py-3 px-4 border border-gray-400 rounded-md"/>
            <button class="w-full bg-red-500 text-white p-3 rounded-lg font-semibold text-lg mt-6" type="submit">Mettre
                à jour
            </button>
